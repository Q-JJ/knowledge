import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-84f3504c.js";const t={},p=e(`<h1 id="路由route" tabindex="-1"><a class="header-anchor" href="#路由route" aria-hidden="true">#</a> 路由route</h1><div class="hint-container info"><p class="hint-container-title">白话理解</p><p>一个路由就是一组映射关系（key - value），route就像是快递分拣中某一条工作线，它起到限制和放行的作用，路由守卫就好比在分拣前、装车前的检查。回到Vue中，route可以配置页面的路由规则，配置跳转的页面；可以设置路由守卫来达到某个条件后执行某些操作，你可以配置一个全局路由守卫，也可以在不同页面配置组件内守卫。</p></div><ol><li><p>前端路由：key是路径，value是组件。</p></li><li><p>创建路由组件【一般放在views|pages文件夹】</p></li><li><p>创建router文件夹，index.js</p></li></ol><h2 id="基本使用" tabindex="-1"><a class="header-anchor" href="#基本使用" aria-hidden="true">#</a> 基本使用</h2><ol><li><p>安装vue-router，命令：<code>npm i vue-router</code></p></li><li><p>应用插件：<code>Vue.use(VueRouter)</code></p></li><li><p>编写router配置项:</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">//引入VueRouter</span>
